...
import { BarChart3, ShieldCheck, Target, Menu, X } from 'lucide-react';
...
const LandingPage: React.FC<LandingPageProps> = ({ onStart }) => {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F19] text-[#E5E7EB] font-sans selection:bg-[#FF5200] selection:text-white relative flex flex-col">
      ...
      {/* Using inline style for the pattern background to match HTML version */}
      <nav 
        className="fixed w-full z-50 border-b border-white/10 bg-[#0B0F19] transition-all duration-300"
        style={{ 
          backgroundImage: "url('/IgniteAI.Logo.jpg')", 
          backgroundSize: 'cover', 
          backgroundPosition: 'center' 
        }}
      >
        {/* Dark overlay for readability */}
        <div className="absolute inset-0 bg-[#0B0F19]/95 z-0" />
        ...
        {/* Mobile Dropdown */}
        {isMobileMenuOpen && (
          <div className="xl:hidden bg-[#0B0F19] border-b border-white/10 relative z-10">
      ...
      <main className="flex-grow flex flex-col items-center justify-center pt-32 pb-20 px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl mb-16">
          {[
            ...
            <div key={idx} className="bg-[#111827]/70 backdrop-blur-md border border-white/10 p-8 rounded-2xl flex flex-col items-center text-center hover:-translate-y-2 hover:border-[#FF5200]/50 transition-all duration-300 group">
        ...
        {/* CTA BUTTON (Using your custom Button.tsx) */}
      ...
      <footer className="border-t border-white/10 py-16 bg-[#0B0F19]/90 relative z-10 w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
                ...
                <div className="flex flex-col space-y-2 text-sm text-gray-500 items-center md:items-start">
                    ...
                    <a href="https://www.igniteaisolutions.co.uk/blog-human-capability.html" className="hover:text-[#FF5200] transition-colors">Insights Blog</a>
                </div>
                <div className="flex flex-col space-y-2 text-sm text-gray-500 items-center md:items-start">
